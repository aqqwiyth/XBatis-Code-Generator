...
public class GenTable {
    ...
    public GenTable(DbConn dbConn) {
        ...
        /**从主键取key allTablePK = getAllTablePK();**/
        /**从唯一索引主键取key**/allTablePK = getAllTablePKBYIndex();
    }
